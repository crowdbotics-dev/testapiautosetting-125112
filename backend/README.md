...
## Project Structure
    ...
    ├── testapiautosetting_125112  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125112`
...
2. Clone this repo and `cd testapiautosetting_125112`
